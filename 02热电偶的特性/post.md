...
### 八.实验结论
&emsp;&emsp;本实验使用快速变温控温实验仪($Pt100$)的温度为参照，测量了热电偶的温差电动势随着热端温度变化的特性，并通过回归拟合得到了其温差系数$C_1=63.90 \mu V/℃$,$C_2=63.73 \mu V/℃$，得出接入中间导体前后的温差系数$C_1≈C_2$，验证了中间导体定律;通过测得 $E_{0-\text{手}}=2.18mV; E_{\text{手}-75}=2.19mV; E_{0-75}=4.36mV$ ，故而 $E_{0-\text{手}} +E_{\text{手}-75} \approx E_{0-75}$ ，验证中间温度定律。实验结果表明，热电偶的温差电动势与温度差成正比，且中间导体定律和中间温度定律均成立。
