...
# <center>物理实验报告 </center>
 <center>陈建烨 12411913 2025.4.22 P4118</center> <!---这里是姓名栏--->
...
(2)$\phi_2-\phi_1={\pi \over 4},f_y=1200Hz$:
<div style="margin-bottom: 20px">
<img style="border-radius: 0.3125em;height:200px;display:block; margin:auto;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="示波器\45.png">
...
(3)$\phi_2-\phi_1={\pi \over 2},f_y=1200Hz$:
<div style="margin-bottom: 20px">
<img style="border-radius: 0.3125em;height:200px;display:block; margin:auto;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="示波器\90.png">
...
(4)$\phi_2-\phi_1={3 \over 4}\pi,f_y=1200Hz$:
<div style="margin-bottom: 20px">
<img style="border-radius: 0.3125em;height:200px;display:block; margin:auto;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="示波器\135.png">
...
(6)$\phi_2-\phi_1={5 \over 4}\pi,f_y=1200Hz$:
<div style="margin-bottom: 20px ">
<img style="border-radius: 0.3125em;height:200px;display:block; margin:auto;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="示波器\225.png">
...
(7)$\phi_2-\phi_1={3 \over 2}\pi,f_y=1200Hz$:
<div style="margin-bottom: 20px">
<img style="border-radius: 0.3125em;height:200px;display:block; margin:auto;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="示波器\270.png">
...
(8)$\phi_2-\phi_1={7 \over 4}\pi,f_y=1200Hz$:
<div style="margin-bottom: 20px">
<img style="border-radius: 0.3125em;height:200px;display:block; margin:auto;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="示波器\315.png">
...
(9)$\phi_2-\phi_1=0,f_y=600Hz,\frac{f_y}{f_x}={1\over2}$:
<div style="margin-bottom: 20px">
<img style="border-radius: 0.3125em;height:200px;display:block; margin:auto;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="示波器\12.png">
...
(10)$\phi_2-\phi_1=0,f_y=400Hz,\frac{f_y}{f_x}={1\over3}$:
<div style="margin-bottom: 20px">
<img style="border-radius: 0.3125em;height:200px;display:block; margin:auto;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="示波器\13.png">
